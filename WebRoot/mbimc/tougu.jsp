...
<body>
	...
	<div id="touguContent">
		...
		<div class="touguMessage">
			<h2 class="touguTitle">证券投资顾问服务协议</h2>
			<div class="twoSides">
				<p>
			...
			<div class="product">
				...
				<p>
					...
					公司注册地址：上海市黄浦区淡水路277号SOHO复兴广场B楼B503室<br /> 客户服务及咨询渠道：<span
						class="color">021-63319055</span><br /> 投诉受理渠道：<span
						class="color">021-63319055</span><br /> 公司网站：www.mbimc.com
				</p>
			...
			if (inputValue != 1) {
				...
				$.ajax({
					...
					success : function(data) {
						//alert(data.msg);
						$(".spinner").hide();
						location.href = '../mbimc/shenhe.jsp'
					},
