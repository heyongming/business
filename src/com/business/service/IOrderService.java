...
public interface IOrderService {
	 ...
	 * @param goodsList 购买的商品信息
	 * @param orderForm 购买时商品信息
	 * @param user      购买书的用户信息
	 * @return 			相关提示
	 */
	...
	/**
	 * @param buyGoodsList 购买的商品
	 * @param buyorderForm 购买的时候的账单 
	 * @param userEntitys	购买者
	 * @param upGoodsList	升级前的商品 假如有的话
	 * @return
	 */
	String saveBuyoeder(GoodsList buyGoodsList,OrderForm buyorderForm,User userEntitys,GoodsList upGoodsList );
}
